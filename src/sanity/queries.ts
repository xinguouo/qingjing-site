...
export const homePageQuery = defineQuery(`*[
  ...
  featuredStudyProgramsTargetPage,
  featuredStudyProgramsExternalUrl,
  ...
  featuredEventsTargetPage,
  featuredEventsExternalUrl,
  ...
  featuredArtWorksTargetPage,
  featuredArtWorksExternalUrl,
  featuredArtWorksViewAllHref,
  featuredArtWorks[]->{${homeArtWorkCardFields}},
  featuredProductsTargetPage,
  featuredProductsExternalUrl,
