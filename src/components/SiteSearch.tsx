...
const labels = {
  ...
  placeholder: {
    zh: "\u641c\u7d22\u9875\u9762\u3001\u6d3b\u52a8\u3001\u827a\u672f\u5bb6...",
    en: "Search pages, events, artists...",
  },
  placeholderMobile: {zh: "\u641c\u7d22", en: "Search"},
};
...
export function SiteSearch({
  ...
  const placeholder =
    variant === "mobile"
      ? labels.placeholderMobile[locale]
      : labels.placeholder[locale];
  ...
  return (
    <div
      className={`relative ${variant === "mobile" ? "z-50 min-w-0 flex-1" : "z-50"}`}
      ref={rootRef}
    >
      ...
      {shouldShowPanel ? (
        <div
          className={`glass-card absolute top-[calc(100%+8px)] overflow-hidden rounded-[16px] border border-[var(--border)] shadow-[0_24px_70px_rgba(0,0,0,0.16)] ${
            variant === "mobile"
